      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Discover amazing products and manage your orders
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <Link
            href="/login"
            className="w-full bg-white hover:bg-gray-50 text-gray-900 font-medium py-3 px-4 rounded-lg border border-gray-300 transition-colors duration-200 flex items-center justify-center"
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500 mb-4">
            Already have an account? You can also access your orders and account settings after logging in.
          </p>
